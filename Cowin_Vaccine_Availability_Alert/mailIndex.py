...
mailBody= f"<b>Hi Sir/Ma'am <br><br> <i>Please find the attached excel availabilty of vaccine between date {args.start_date} and {args.end_date}</i> <br><br> Regards <br> Akash Verma </b>"
mailSub = "Cowin Vaccine Availability Alert Excel"
